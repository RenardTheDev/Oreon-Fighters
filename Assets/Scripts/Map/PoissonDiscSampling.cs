...
{
    [System.ThreadStatic] private static Random _local;

    public static List<Vector3> GeneratePoints(float radius, Vector3 sampleRegionSize, int numSamplesForeRejection = 30)
    {
        ...
        while (spawnPoints.Count > 0)
        {
            ...
            for (int i = 0; i < numSamplesForeRejection; i++)
            {
